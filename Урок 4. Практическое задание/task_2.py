...
против O(n^2) в первом случае. На малых значениях (до i<= 10) второй вариант жизнеспособен, но далее время работы увеличивается
в прогрессии, что делает его совершенно нерабочим
'''